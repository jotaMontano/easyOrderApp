...
export class CategoryService {
    ...
    public getCategoriesByClient(id: number, req?: any): Observable<HttpResponse<ICategory[]>> {
        const options = createRequestOption(req);
        return this.http.get<ICategory[]>(`${this.resourceUrl}/getCategoriesByClient/${id}`, { params: options, observe: 'response' });
    }
}
