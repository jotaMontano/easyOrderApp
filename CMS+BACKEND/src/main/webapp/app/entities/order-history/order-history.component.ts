...
export class OrderHistoryComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.orderHistoryService
            ...
            .subscribe(
                (res: HttpResponse<IOrderHistory[]>) => this.paginateOrderHistories(res.body, res.headers),
    ...
    protected paginateOrderHistories(data: IOrderHistory[], headers: HttpHeaders) {
