...
import { ListOfValueComponent } from 'app/entities/list-of-value/list-of-value.component';
...
describe('Component Tests', () => {
    describe('ListOfValue Management Component', () => {
        let comp: ListOfValueComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ListOfValueComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.listOfValues[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
