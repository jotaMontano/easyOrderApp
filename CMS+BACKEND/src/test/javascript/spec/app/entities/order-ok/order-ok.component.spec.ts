...
import { OrderOkComponent } from 'app/entities/order-ok/order-ok.component';
import { OrderOkService } from 'app/entities/order-ok/order-ok.service';
import { OrderOk } from 'app/shared/model/order-ok.model';

describe('Component Tests', () => {
    describe('OrderOk Management Component', () => {
        let comp: OrderOkComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(OrderOkComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.orderOks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
